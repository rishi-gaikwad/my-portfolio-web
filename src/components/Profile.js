...
import { DiWebplatform, DiReact, DiNodejs, } from 'react-icons/di'
function Profile() {
    ...
    return (
        <Flex direction={isNotSmallerScreen ? "row" : "column"} w="100%"
            ...
            <Box alignSelf="center" px="32" py="16">
                <Text fontWeight="bold" fontSize="2xl">FullStack Developer, Specialised in Web App Development.</Text>
